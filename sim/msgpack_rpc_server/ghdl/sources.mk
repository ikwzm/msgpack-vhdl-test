...
msgpack_kvmap_query_array.o : ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_query_array.vhd msgpack_object.o msgpack_object_components.o msgpack_object_decode_map.o msgpack_object_encode_map.o msgpack_object_decode_integer.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_query_array.vhd
...
msgpack_kvmap_store_array.o : ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_store_array.vhd msgpack_object.o msgpack_object_components.o msgpack_object_decode_map.o msgpack_object_decode_integer.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_store_array.vhd
...
msgpack_kvmap_query_integer_array.o : ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_query_integer_array.vhd msgpack_object.o msgpack_object_components.o msgpack_kvmap_components.o msgpack_kvmap_key_compare.o msgpack_kvmap_query_array.o msgpack_kvmap_query_stream_parameter.o msgpack_object_encode_integer_array.o
...
msgpack_kvmap_store_integer_array.o : ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_store_integer_array.vhd msgpack_object.o msgpack_object_components.o msgpack_kvmap_components.o msgpack_kvmap_key_compare.o msgpack_kvmap_store_array.o msgpack_object_decode_integer_array.o
...
proc_kvmap_get_value_sample.o : ../../../src/msgpack_rpc_server/vhdl/proc_kvmap_get_value_sample.vhd msgpack_rpc.o msgpack_object.o msgpack_rpc_components.o msgpack_kvmap_components.o msgpack_rpc_server_kvmap_get_value.o msgpack_kvmap_query_integer_register.o msgpack_kvmap_query_integer_array.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_server/vhdl/proc_kvmap_get_value_sample.vhd

proc_kvmap_set_value_sample.o : ../../../src/msgpack_rpc_server/vhdl/proc_kvmap_set_value_sample.vhd msgpack_rpc.o msgpack_object.o msgpack_rpc_components.o msgpack_kvmap_components.o msgpack_rpc_server_kvmap_set_value.o msgpack_kvmap_store_integer_register.o msgpack_kvmap_store_integer_array.o
