...
msgpack_object_decode_binary_stream.o : ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_decode_binary_stream.vhd msgpack_object.o msgpack_object_components.o pipework_components.o msgpack_object_decode_binary_core.o reducer.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_decode_binary_stream.vhd
...
msgpack_object_query_binary_stream.o : ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_query_binary_stream.vhd msgpack_object.o msgpack_object_components.o msgpack_object_query_stream_parameter.o msgpack_object_encode_binary_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_query_binary_stream.vhd

msgpack_object_store_binary_stream.o : ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_store_binary_stream.vhd msgpack_object.o msgpack_object_components.o msgpack_object_decode_binary_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_store_binary_stream.vhd
...
msgpack_kvmap_query_binary_stream.o : ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_query_binary_stream.vhd msgpack_object.o msgpack_object_components.o msgpack_kvmap_components.o msgpack_kvmap_key_compare.o msgpack_object_query_binary_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_query_binary_stream.vhd

msgpack_kvmap_store_binary_stream.o : ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_store_binary_stream.vhd msgpack_object.o msgpack_object_components.o msgpack_kvmap_components.o msgpack_kvmap_key_compare.o msgpack_object_store_binary_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_store_binary_stream.vhd
...
BinaryStream_Fifo.o : ../../../src/msgpack_rpc_binary_stream/vhdl/BinaryStream_Fifo.vhd 
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_binary_stream/vhdl/BinaryStream_Fifo.vhd

BinaryStream_Interface.o : ../../../src/msgpack_rpc_binary_stream/vhdl/BinaryStream_Interface.vhd msgpack_object.o msgpack_rpc.o msgpack_rpc_components.o msgpack_kvmap_components.o msgpack_rpc_server.o msgpack_rpc_server_kvmap_get_value.o msgpack_kvmap_query_binary_stream.o msgpack_rpc_server_kvmap_set_value.o msgpack_kvmap_store_binary_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_binary_stream/vhdl/BinaryStream_Interface.vhd

BinaryStream_Server.o : ../../../src/msgpack_rpc_binary_stream/vhdl/BinaryStream_Server.vhd BinaryStream_Interface.o BinaryStream_Fifo.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_binary_stream/vhdl/BinaryStream_Server.vhd

test_bench.o : ../../../src/msgpack_rpc_binary_stream/vhdl/test_bench.vhd BinaryStream_Server.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_binary_stream/vhdl/test_bench.vhd
