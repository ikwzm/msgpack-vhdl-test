...
set project_name            "msgpack_object_unpacker"
...
set_property "top" "Msgpack_Object_Unpacker"  $obj
#
# Set 'sim_1' fileset properties
#
set obj [get_filesets sim_1]
set_property "top" "TEST_BENCH"  $obj
set_property "generic" "SCENARIO_FILE=../../../../../../src/msgpack_object_unpacker/scenarios/test_1.snr" $obj

update_compile_order -fileset sources_1
update_compile_order -fileset sim_1
set_property source_mgmt_mode DisplayOnly [current_project]
reorder_files -front -fileset sources_1 [file normalize ../../../msgpack-vhdl/src/msgpack/object/msgpack_object.vhd]
