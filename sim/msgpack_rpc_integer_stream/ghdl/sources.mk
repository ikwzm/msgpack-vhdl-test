...
msgpack_object_query_integer_stream.o : ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_query_integer_stream.vhd msgpack_object.o msgpack_object_components.o msgpack_object_query_stream_parameter.o msgpack_object_encode_integer_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_query_integer_stream.vhd

msgpack_object_store_integer_stream.o : ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_store_integer_stream.vhd msgpack_object.o msgpack_object_components.o msgpack_object_decode_integer_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/object/msgpack_object_store_integer_stream.vhd
...
msgpack_kvmap_query_integer_stream.o : ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_query_integer_stream.vhd msgpack_object.o msgpack_object_components.o msgpack_kvmap_components.o msgpack_kvmap_key_compare.o msgpack_object_query_integer_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_query_integer_stream.vhd

msgpack_kvmap_store_integer_stream.o : ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_store_integer_stream.vhd msgpack_object.o msgpack_object_components.o msgpack_kvmap_components.o msgpack_kvmap_key_compare.o msgpack_object_store_integer_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../msgpack-vhdl/src/msgpack/kvmap/msgpack_kvmap_store_integer_stream.vhd
...
IntegerStream_Fifo.o : ../../../src/msgpack_rpc_integer_stream/vhdl/IntegerStream_Fifo.vhd 
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_integer_stream/vhdl/IntegerStream_Fifo.vhd

IntegerStream_Interface.o : ../../../src/msgpack_rpc_integer_stream/vhdl/IntegerStream_Interface.vhd msgpack_object.o msgpack_rpc.o msgpack_rpc_components.o msgpack_kvmap_components.o msgpack_rpc_server.o msgpack_rpc_server_kvmap_get_value.o msgpack_kvmap_query_integer_stream.o msgpack_rpc_server_kvmap_set_value.o msgpack_kvmap_store_integer_stream.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_integer_stream/vhdl/IntegerStream_Interface.vhd

IntegerStream_Server.o : ../../../src/msgpack_rpc_integer_stream/vhdl/IntegerStream_Server.vhd IntegerStream_Interface.o IntegerStream_Fifo.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_integer_stream/vhdl/IntegerStream_Server.vhd

test_bench.o : ../../../src/msgpack_rpc_integer_stream/vhdl/test_bench.vhd IntegerStream_Server.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_integer_stream/vhdl/test_bench.vhd
