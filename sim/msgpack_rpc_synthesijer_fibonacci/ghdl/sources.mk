...
Fib.o : ../../../src/msgpack_rpc_synthesijer_fibonacci/vhdl/Fib.vhd 
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_synthesijer_fibonacci/vhdl/Fib.vhd

Fib_Interface.o : ../../../src/msgpack_rpc_synthesijer_fibonacci/vhdl/Fib_Interface.vhd msgpack_object.o msgpack_rpc.o msgpack_rpc_components.o msgpack_object_components.o msgpack_rpc_server.o msgpack_rpc_method_main_with_param.o msgpack_object_store_integer_register.o msgpack_rpc_method_return_integer.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_synthesijer_fibonacci/vhdl/Fib_Interface.vhd

Fib_Server.o : ../../../src/msgpack_rpc_synthesijer_fibonacci/vhdl/Fib_Server.vhd Fib_Interface.o Fib.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_synthesijer_fibonacci/vhdl/Fib_Server.vhd

test_bench.o : ../../../src/msgpack_rpc_synthesijer_fibonacci/vhdl/test_bench.vhd Fib_Server.o
	ghdl -a -C $(GHDLFLAGS) --work=MSGPACK ../../../src/msgpack_rpc_synthesijer_fibonacci/vhdl/test_bench.vhd
